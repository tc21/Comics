...
namespace Comics {
    ...
    public class Comic : INotifyPropertyChanged {
        ...
        public string ContainingPath { get; }
        ...
        public int UniqueHashCode() {
            return this.title.GetHashCode() ^ this.author.GetHashCode() ^ this.category.GetHashCode() ^ this.ContainingPath.GetHashCode();
        }
        ...
        public void OpenContainingFolder() {
            Process.Start(this.ContainingPath);
        }
