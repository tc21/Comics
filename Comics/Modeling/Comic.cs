...
namespace Comics {
    ...
    public class Comic : INotifyPropertyChanged {
        ...
        public string ThumbnailSourcePath => this.Metadata.ThumbnailSource ?? FirstImageInComic(this);
        ...
        public List<string> FilePaths => RetrieveFilesForComicAtPath(this.path);
        ...
        private static List<string> RetrieveFilesForComicAtPath(string path, int currentDepth = 0) {
            DirectoryInfo di = new DirectoryInfo(path);
            return RetrieveFilesForComicAtPath(di, currentDepth);

        }

        private static List<string> RetrieveFilesForComicAtPath(DirectoryInfo dir, int currentDepth = 0) {
            ...
            if (Defaults.Profile.SubdirectoryAction == Defaults.SubdirectoryAction.COMBINE
                ...
                foreach (var subdir in dirs) {
                    contained.AddRange(RetrieveFilesForComicAtPath(subdir, currentDepth));
                }
            }
        ...
        public void CreateThumbnail() {
            ...
            if (File.Exists(this.ThumbnailSourcePath) &&
                Thumbnails.CreateThumbnailFromImage(this.ThumbnailSourcePath, width, this.ThumbnailPath)) {
            } else if (Thumbnails.CanCreateThumbnailFromAudio(this.ThumbnailSourcePath) &&
                       Thumbnails.CreateThumbnailFromAudio(this.ThumbnailSourcePath, width, this.ThumbnailPath)) {
            } else if (Thumbnails.CanCreateThumbnailFromVideo(this.ThumbnailSourcePath) &&
                       Thumbnails.CreateThumbnailFromVideo(this.ThumbnailSourcePath, width, this.ThumbnailPath)) {
        ...
        public HashSet<string> Tags {
            ...
            set { this.Metadata.Tags = value; SaveMetadata(); NotifyPropertyChanged("Tags"); }
        }
